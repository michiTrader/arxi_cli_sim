...
var Keys = []KeyDecl{
	...
	{"tool.status.error", "the word a failed call is reduced to in the compact output level"},
	{"tool.status.denied", "the word a policy-refused call is reduced to in the compact output level"},
	{"tool.count.add", "the added-line count a compact tool call shows in place of its diff"},
	{"tool.count.del", "the removed-line count a compact tool call shows in place of its diff"},
	...
	{"input.hint", "the transient notice let into that border's right end, such as the output level"},
	...
	{"extension.frame", "the border of an extension full-frame panel"},
	{"extension.frame.focused", "that border while the extension panel has focus"},
	{"extension.title", "the title of an extension panel"},
	{"extension.title.focused", "that title while the extension panel has focus"},
	{"extension.text", "ordinary extension-provided text"},
	{"extension.muted", "secondary extension-provided text"},
	{"extension.accent", "extension text requiring neutral emphasis"},
	{"extension.success", "extension text reporting success"},
	{"extension.warning", "extension text reporting a warning"},
	{"extension.error", "extension text reporting an error"},
	{"extension.key", "a key or action hint supplied by an extension"},
	{"extension.footer", "structural text in an extension panel footer"},
	{"extension.stale", "the marker on an extension panel showing old data"},
